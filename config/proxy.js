var proxyTable = {
    '/api': {
      // target: 'http://192.168.29.149:10004/', //设置你调用的接口域名和端口号
      // target: 'http://192.168.29.119:10004/', //设置你调用的接口域名和端口号
      target: 'http://192.168.28.41:9736/', //设置你调用的接口域名和端口号
      // target: 'http://192.168.28.217:10004', //设置你调用的接口域名和端口号
      // target: 'http://192.168.29.136:10004/', //设置你调用的接口域名和端口号
      // target: 'http://192.168.29.136:10004/', //设置你调用的接口域名和端口号
      authorization: false,
